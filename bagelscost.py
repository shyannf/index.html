# Name: shyann-forthman
# Prog Purpose: This program creates a sales reciept for Brownsville Bagels
...
def display_results():
    ...
    print('Fresh bakes bagels every day!')
    print('------------------------------')
    print('Bagels       $ ' + format(subtotal,'8,.2f'))
    print('Cream Cheese $ ' + format(cost_creamch))
    print('------------------------------')
